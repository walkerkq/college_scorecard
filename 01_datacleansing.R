...
data <- data0[ , c(4, 6, 15, 16, 17, 19, 37, 291, 377, 382, 383, 
                   384, 386, 387, 429, 438, 440, 441, 1432, 1730)] 

colnames(data) <- c("School", "State", "Predominant.Degree", "Highest.Degree", 
                    "Type", "Region", "Adm.Rate", "Enrollment", "Avg.Cost", 
                    "Net.Revenue", "Inst.Expense", "Avg.Faculty.Pay", 
                    "Pell.Grant.Pct", "Completion", "Retention",  "Pct.Fed.Loan", 
                    "Default.2Y", "Default.3Y", "Avg.Fam.Income.Dependent", "Year")
